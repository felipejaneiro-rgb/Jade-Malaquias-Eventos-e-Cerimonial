...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-jade-light dark:bg-neutral-900 text-jade-dark dark:text-jade-light transition-colors duration-500 selection:bg-jade-secondary selection:text-jade-dark">
      ...
      {/* 3. Services Section */}
      {/* Changed background to a gradient to smooth transition from 'About' section, now more aggressive with 'via' */}
      <section id="servicos" className="py-20 px-6 bg-gradient-to-b from-white via-jade-rose to-jade-rose dark:from-neutral-900 dark:via-neutral-950 dark:to-neutral-950 transition-colors duration-500">
      ...
      <section id="portfolio" className="py-24 bg-gradient-to-b from-white via-zinc-300 to-zinc-300 dark:from-neutral-900 dark:via-black dark:to-black transition-colors duration-500 overflow-hidden">
         <motion.div 
